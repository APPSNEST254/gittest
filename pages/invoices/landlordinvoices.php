                            ...
                            <div class="card-header">
                               <div class="card-header pills-regular">
                                        ...
                                        <ul class="nav nav-pills card-header-pills"  role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link " href="invoice.php"role="tab" >Tenant Invoices</a>
                                            </li>
											
                                            <li class="nav-item">
                                                <a class="nav-link active"  href="landlordinvoices.php">Landlord Invoices</a>
                                            </li>
...
$selcount="SELECT SUM(invoicedamount) AS dueinvoiced FROM landlordinvoices
...
$selcount5="SELECT SUM(paidamount) AS paidinvoice FROM landlordinvoices
...
WHERE propertyid='$storedname' and status='ADVANCE'"; 

$selcount7k=mysqli_query($connect,$selcount9k);
$row7=mysqli_fetch_array($selcount7k);
$advance=$row7['advance'];


$totaldue=$dueinvoiced+$balances-$advance;
...
<a class='btn btn-primary btn-sm'  href ='landlordinvoice1.php?act=details& propertyid=".$propertyid."'>
Details
</a>
</td>";
echo "</tr>"; 
