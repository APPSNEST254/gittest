...
?>	
                                            <tr>
											 ...
											 <a href="#" class="btn btn-warning"data-toggle="modal" data-target="#exampleModal">Advance Payments</a>
				...
				<?php include 'genlandlordinvoice.php'; ?>
                ...
                <!-- ============================================================== -->
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="c-nav">
                                    <h3 class="section-title">Landlord Invoices</h3>
                                                                    </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-header pills-regular">
                                        <ul class="nav nav-pills card-header-pills" id="myTab2" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="card-pills-1" data-toggle="tab" href="#card-pill-1" role="tab" aria-controls="card-1" aria-selected="true">Due Invoices</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="card-pills-2" data-toggle="tab" href="#card-pill-2" role="tab" aria-controls="card-2" aria-selected="false">Advance Payments</a>
                                            </li>
                                            <li class="nav-item">
                        ...
                        <!-- ============================================================== -->
									...
									<?php include 'landlorddueinvoices.php'; ?>
                        ...
                        <!-- ============================================================== -->
                                            <div class="tab-pane fade" id="card-pill-2" role="tabpanel" aria-labelledby="card-tab-2">
                                             <?php include 'landlordadvance.php'; ?>
                        ...
                        <!-- ============================================================== -->
                                            <div class="tab-pane fade" id="card-pill-4" role="tabpanel" aria-labelledby="card-tab-4">
                                             <?php include 'landlordbalances.php'; ?>
											  </div>
