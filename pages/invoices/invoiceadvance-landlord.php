...
$sel9a=mysqli_query($connect,$select9a);
	$row=mysqli_fetch_array($sel9a);		
          ...
          <!-- ============================================================== -->  							   
<div class="modal fade" <?php echo "id='invoiceadvancelandlord".$invoiceno."'>";?> tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
       ...
       <!-- ============================================================== -->
					...
					<div class="card" id='printinvoiceadvance'>
                                <div class="card-header p-4">
                                    ...
                                    <div class="float-right"> <h3 class="mb-0">RNo <?php echo  $rno ;?></h3>
                                     Date Paid:  <?php echo  $paymentdate ?>
									<br> Invoice No:  <?php echo  $invoiceno ?></div>
                                </div>
                                <div class="card-body">
                                  <div class="row">
...
<h4 class="right">Total Cost:</h4> 
		...
		<div class="row">
	   <div class="col">
<p class="Left">Advance Paid:</p>  
	</div>
	
	 <div class="col">

<p class="right"><?php echo  $advanceamount ?></p> 
	</div>
