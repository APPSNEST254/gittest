                            ...
                            <div class="card-header">
                               <div class="card-header pills-regular">
                                        ...
                                        <ul class="nav nav-pills card-header-pills"  role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" href="invoices.php"role="tab" >Tenant Invoices</a>
                                            </li>
											<li class="nav-item">
                                                <a class="nav-link"  href="advancerent.php" >Advance rent</a>
                                            </li>
                                            <li class="nav-item">
											...
											<li class="nav-item">
                                                <a class="nav-link"  href="landlordadvance.php" >Landlord Advance</a>
                                            </li>
											<li>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</li>
...
$selcount="SELECT SUM(invoicedamount) AS dueinvoiced FROM tenanatinvoices
...
$overdueinvoiced=$row4['unoccupied'];
...
$totaldue=$dueinvoiced+$overdueinvoiced+$booked;

echo "<td>".$totaldue."</td>";
echo "<td>".$dueinvoiced."<BR><a  href ='propertyvacantunits.php?act=view&propertyid=".$propertyid."'>View</td>";
echo "<td>".$booked."<BR><a  href ='propertybookedunits.php?act=view&propertyid=".$propertyid."'>View</td>";
echo "<td>".$occupied."<BR><a  href ='propertyoccupiedunits.php?act=view&propertyid=".$propertyid."'>View</td>";
