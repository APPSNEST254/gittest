...
?>
								  ...
								  <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        <thead>
                                         <tr>
										 <th COLSPAN=8>BALANCE BROUGHT FOWARD</th>
                                         </tr>
                                         <tr>
...
$select3b="SELECT * FROM balances WHERE propertyid='$propertyid' AND unitid='$unitid' AND tenantid='$idno' AND status='DUE' ORDER BY invoiceno DESC" ;
