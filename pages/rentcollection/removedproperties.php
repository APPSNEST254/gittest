        ...
        <!-- ============================================================== -->
            ...
            <div class="container-fluid dashboard-content">
                <div class="row">
                               ...
                               <div class="card-header pills-regular">
                                        ...
                                        <ul class="nav nav-pills card-header-pills"  role="tablist">
                                            ...
                                            <li class="nav-item">
											    ...
											    <li class="nav-item">
                                                <a class="nav-link active" href="removedproperties.php"role="tab" >Removed</a>
                                            </li>
                 ...
                 $select="SELECT * FROM property WHERE agencyid='$agencyid' AND status='REMOVED' ORDER BY regdate ASC";
...
echo "<td>".$unoccupied."<BR><a  href ='propertyvacantunits.php?act=view&propertyid=".$propertyid."'>View</td>";
