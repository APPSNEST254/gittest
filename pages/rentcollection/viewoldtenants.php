<!-- start table 1  -->
                        <!-- ============================================================== -->
                                            ...
                                            <div class="tab-pane fade" id="card-pill-5" role="tabpanel" aria-labelledby="card-tab-5">
                                 
									<div class="table-responsive">
                                     <table id="example4" class="table table-striped table-bordered first">
                                         <thead>
                                         <tr>
                                        <th>NO</th>
                                        <th>UNIT NO</th>
                                        ...
                                        <tbody> <?php     //script to be used to view details of registered hospitals 
...
FROM tenants
LEFT JOIN units
ON tenants.unitid = units.unitid and tenants.propertyid = units.propertyid LEFT JOIN property ON tenants.propertyid= property.propertyid WHERE tenants.propertyid = '$propertyid' and property.agencyid='$agencyid' AND tenants.status='CHECKED-OUT' ORDER BY units.unitid ASC";
